(function () {
  ...
  const translations = {
    ...
    ro: {
      ...
      'menu.subtitle': 'Actualizat în fiecare dimineață — deschis în fiecare zi la prânz',
      ...
      'feat.soup.desc':    'Ciorbă de burtă, borș de pui și sarmale fierte înăbușit în fiecare zi.',
      ...
      'about.body2':       'Fiecare preparat spune o călătorie prin tradiții diferite, unite de aceeași valoare: plăcerea de a împărtăși o masă bună. Aici puteți savura ce e mai bun din bucătăria românească, moldovenească și italiană într-un ambient primitor, unde fiecare oaspete este primit ca un prieten.',
      ...
      'str.intro':         'Jarul Domnesc Official oferă spații primitoare și versatile, concepute atât pentru prânzul de zi cu zi, cât și pentru ocazii speciale. Fiecare spațiu este îngrijit în detalii pentru a garanta confort și o atmosferă autentic românească.',
      'str.sala1.title':   'Sala Principală',
      'str.sala1.meta1':   'până la [X] locuri',
      'str.sala1.meta2':   'cu ferestre',
      'str.sala1.desc':    'Sala principală a restaurantului, luminoasă și primitoare. Ideală pentru prânzuri în familie, cine romantice și mese cu prietenii. Mobilier cald și atmosferă tipic românească.',
      'str.sala2.title':   'Sală Privată',
      'str.sala2.meta1':   'până la [X] locuri',
      'str.sala2.meta2':   'rezervabilă',
      'str.sala2.desc':    'Sală rezervată, ideală pentru grupuri mici, întâlniri de afaceri sau celebrări exclusive. Poate fi amenajată personalizat în funcție de eveniment.',
      'str.sala3.title':   'Spațiu Exterior',
      'str.sala3.meta1':   'până la [X] locuri',
      'str.sala3.meta2':   'sezonier',
      'str.sala3.desc':    'Zonă exterioară disponibilă în sezonul cald. Perfectă pentru aperitive, cine de vară și momente de relaxare în aer liber într-un cadru liniștit.',
      'str.cta.h2':        'Vrei să ne vizitezi sau să rezervi un spațiu?',
      'str.cta.p':         'Contactează-ne pentru informații despre disponibilitate și pentru a-ți organiza vizita.',
      'str.cta.btn':       'Contactează-ne',
      'ev.hero.h1':        'Evenimente Private',
      'ev.hero.p':         'Botezuri, comuniuni, zile de naștere, cine de afaceri și multe altele',
      'ev.intro':          'Fie că e un botez cu toată familia sau o cină de sfârșit de an cu colegii, la Jarul Domnesc fiecare masă contează. Stabilim meniul, decorul și orarul — noi ne ocupăm de detalii, tu te bucuri de ocazie.',
      'ev.card1.h3':       'Botezuri',
      'ev.card1.p':        'O zi de neuitat pentru toată familia. Meniu personalizat, sală rezervată și atenție la fiecare detaliu.',
      'ev.card2.h3':       'Comuniuni &amp; Confirmări',
      'ev.card2.p':        'Sărbătorește ziua cea mare cu un prânz sau o cină dedicată, într-un mediu cald și primitor.',
      'ev.card3.h3':       'Zile de Naștere',
      'ev.card3.p':        'Petreceri de zi de naștere pentru toate vârstele: de la o seară cu prietenii la o masă în familie cu tort inclus.',
      ...
      'ev.card5.p':        'Team building, cine de sfârșit de an sau prânzuri de lucru: spații discrete și meniuri potrivite oricărui buget.',
      'ev.card6.h3':       'Petreceri Private',
      'ev.card6.p':        'Orice altă ocazie de sărbătorit: licențe, promovări, reîntruniri de familie. Contactează-ne și construim împreună evenimentul tău.',
      'ev.how.h2':         'Cum organizăm evenimentul tău',
      'ev.step1.h4':       'Ne contactezi',
      'ev.step1.p':        'Sună-ne sau scrie-ne cu data, numărul de persoane și tipul de eveniment.',
      'ev.step2.h4':       'Definim detaliile',
      'ev.step2.p':        'Alegem împreună meniul, decorul și orarul. Totul personalizat pentru tine.',
      'ev.step3.h4':       'Confirmăm',
      'ev.step3.p':        'Stabilim rezervarea cu un mic avans pentru garantarea datei.',
      'ev.step4.h4':       'Sărbătorește',
      ...
      'ev.cta.btn1':       'Solicită informații',
      'ev.cta.btn2':       'Sună-ne acum',
      'ct.hero.h1':        'Contact',
      'ct.h2':             'Vino să Ne Găsești',
      'ct.addr.h3':        'Adresă',
      'ct.phone.h3':       'Telefon',
      'ct.email.h3':       'Email',
      'ct.hours.h3':       'Program de Funcționare',
