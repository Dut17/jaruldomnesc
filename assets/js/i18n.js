(function () {
  ...
  const translations = {
    ...
    ro: {
      ...
      'menu.subtitle': 'Actualizat in fiecare dimineata &mdash; deschis in fiecare zi la pranz',
      'menu.primo': 'Fel intai', 'menu.secondo': 'Fel principal', 'menu.contorno': 'Garnitura', 'menu.prezzo': 'Pret',
      'menu.loading': 'Se incarca meniul&hellip;',
      ...
      'about.body': 'Restaurantul nostru s-a nascut din intalnirea a trei culturi care iubesc sa stea la masa: cea romaneasca, moldoveneasca si italiana. Am adus la Padova retetele traditiei, aromele autentice de acasa si pasiunea pentru bucataria buna, imbinand ingrediente, mirosuri si povesti care vorbesc despre familie, prietenie si convivialitate.',
      'about.body2': 'Fiecare preparat spune o calatorie prin traditii diferite, unite de aceeasi valoare: placerea de a imparti o masa buna. Aici puteti savura ce e mai bun din bucataria romaneasca, moldoveneasca si italiana intr-un ambient primitor, unde fiecare oaspete este primit ca un prieten.',
      ...
      'ev.intro': 'Fie ca e un botez cu toata familia sau o cina de sfarsit de an, la Jarul Domnesc fiecare masa conteaza. Stabilim meniul, decorul si orarul &mdash; noi ne ocupam de detalii, tu te bucuri de ocazie.',
      'ev.card1.h3': 'Botezuri', 'ev.card1.p': 'O zi de neuitat pentru toata familia. Meniu personalizat, sala rezervata si atentie la fiecare detaliu.',
      'ev.card2.h3': 'Comuniuni &amp; Confirmari', 'ev.card2.p': 'Sarbatoreste ziua cea mare cu un pranz sau o cina dedicata, intr-un mediu cald si primitor.',
      'ev.card3.h3': 'Zile de Nastere', 'ev.card3.p': 'Petreceri de zi de nastere pentru toate varstele: de la o seara cu prietenii la o masa in familie cu tort inclus.',
      'ev.card4.h3': 'Aniversari', 'ev.card4.p': 'Surprinde persoana speciala cu o cina romantica sau un pranz alaturi de cei mai dragi.',
      'ev.card5.h3': 'Cine de Afaceri', 'ev.card5.p': 'Team building, cine de sfarsit de an sau pranzuri de lucru: spatii discrete si meniuri potrivite oricarui buget.',
      'ev.card6.h3': 'Petreceri Private', 'ev.card6.p': 'Orice alta ocazie de sarbatorit: licence, promovari, reintruniri de familie. Contacteaza-ne si construim impreuna evenimentul tau.',
      ...
      'ev.step2.h4': 'Definim detaliile', 'ev.step2.p': 'Alegem impreuna meniul, decorul si orarul. Totul personalizat pentru tine.',
      'ev.step3.h4': 'Confirmam', 'ev.step3.p': 'Stabilim rezervarea cu un mic avans pentru garantarea datei.',
      'ev.step4.h4': 'Sarbatoreste', 'ev.step4.p': 'In ziua evenimentului ne ocupam de tot. Tu bucura-te de fiecare moment.',
      'ev.cta.h2': 'Pregatit sa organizezi evenimentul tau?',
      'ev.cta.p': 'Scrie-ne sau suna-ne: iti spunem imediat disponibilitatea si costurile, fara angajament.',
